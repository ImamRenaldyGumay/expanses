    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Tambah Pemasukkan</h1>
            </div>
            <div class="card-body">
                <!-- Form -->
                <form method="post" action="<?= base_url('Transactions/income_process') ?>">
                    <!-- Input Jumlah -->
                    <div class="mb-3">
                        <label for="amount" class="form-label">Nominal (minimal 100)</label>
